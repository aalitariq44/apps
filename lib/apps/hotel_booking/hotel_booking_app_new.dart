...
class _HotelBookingAppState extends State<HotelBookingApp> {
  ...
  List<Hotel> _hotels = Hotel.getDummyHotels();
  ...
  void _addToSelectedRooms(BookingRoom room) {
    setState(() {
      // Check if room already exists, update quantity or add new
      final existingIndex = _selectedRooms.indexWhere((r) => r.roomId == room.roomId);
      if (existingIndex != -1) {
        _selectedRooms[existingIndex] = BookingRoom(
          roomId: room.roomId,
          roomName: room.roomName,
          roomType: room.roomType,
          quantity: _selectedRooms[existingIndex].quantity + room.quantity,
